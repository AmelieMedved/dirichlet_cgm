import pandas as pd
import os.path
outData = pd.read_csv("tableV2.csv", sep = ',', index_col=0, encoding='cp1251')
if(os.path.exists('tableV2.xlsx')):
  os.remove('tableV2.xlsx')
...
writer = pd.ExcelWriter('tableV2.xlsx',engine='xlsxwriter') 
outData.to_excel(writer,'tableV2') 
writer.save()